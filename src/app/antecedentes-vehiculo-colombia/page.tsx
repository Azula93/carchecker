...
export const metadata: Metadata = {
  title: 'Antecedentes de un vehículo en Colombia: qué consultar antes de comprar',
  description:
      ...
      <article className="max-w-4xl mx-auto px-5 sm:px-6 py-10 md:py-16">
        ...
        <header className="mb-10">
          ...
          <p className="text-lg md:text-xl text-slate-600 leading-8">
            ...
            sobre el vehículo y contrastarla con los datos proporcionados por
            el vendedor.
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <p className="text-slate-700 leading-8 mb-5">
            ...
            que estás evaluando. La información disponible dependerá del
            trámite o servicio que estés consultando.
          </p>
        ...
        <section className="mb-12">
          ...
          <p className="text-slate-700 leading-8 mb-6">
            No toda la información relacionada con un vehículo se encuentra
            en un mismo lugar. Dependiendo de lo que quieras verificar,
            puedes necesitar consultar diferentes plataformas o fuentes.
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="border border-[#E2E8F0] rounded-xl p-6">
              ...
              <p className="text-sm text-[#475569] leading-7">
                Utiliza los canales oficiales correspondientes para consultar
                la información disponible sobre el vehículo y sus trámites.
              </p>
            </div>
            ...
            <div className="border border-[#E2E8F0] rounded-xl p-6">
              ...
              <p className="text-sm text-[#475569] leading-7">
                Consulta la información disponible relacionada con
                infracciones y comparendos mediante los canales oficiales.
              </p>
            </div>
        ...
        <section className="mb-12">
          ...
          <p className="text-slate-700 leading-8 mb-5">
            Consultar una fuente no significa que la revisión haya terminado.
            El siguiente paso consiste en comparar la información obtenida
            con los datos proporcionados por el vendedor y con lo observado
        ...
        <section className="mb-12">
          <div className="rounded-xl border-l-4 border-[#B45309] bg-[#FFFBEB] p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm text-[#475569] leading-7 list-disc pl-5">
              ...
              <li>
                Datos que el vendedor no puede explicar o respaldar.
              </li>
              <li>
                Diferencias importantes entre el estado físico y la
        ...
        <section className="mb-12">
          ...
          <p className="text-slate-700 leading-8 mb-4">
            Las consultas de antecedentes y la revisión documental son una
            parte del proceso de evaluación. No permiten determinar por sí
            solas el estado mecánico, estructural o funcional completo de un
            vehículo.
          </p>

          <p className="text-slate-700 leading-8">
            Cuando existen dudas relevantes, una inspección profesional puede
            aportar información adicional antes de tomar una decisión de
            compra.
          </p>
        </section>
    ...
    >
      ...
      <p className="text-sm text-[#475569] leading-6">
        ...
        <p className="text-xs text-slate-500 leading-6 mt-8">
          <strong>Aviso:</strong> Las consultas de antecedentes deben
          realizarse directamente en las plataformas oficiales o fuentes
          correspondientes. Car Checker funciona como herramienta de
          organización y revisión preliminar y no sustituye las consultas
          oficiales ni un peritaje profesional.
        </p>
      </article>
    </main>
  );
